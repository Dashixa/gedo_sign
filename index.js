    ...
    <table width="100%" cellspacing="0" cellpadding="0"
        ...
        <tr>
            <td style="display: inline-block;">
                <a href="https://gedocorp.ru/" target="_blank">
                    <img src="https://gedocorp.ru/img/logo_sign_dark.png" alt="Company Logo" width="150" height="45"
                        style="display: block;">
                </a>
            </td>
        </tr>
        ...
        <tr>
         ...
         <tr style="margin-top: 25px; display: flex;">
            <td>
                <a href="https://vk.com/gedocorp" target="_blank" style="font-size: 14px; text-decoration: none; margin-right: 20px; color: #3498db;">
                   <img src="https://gedocorp.ru/img/icon_vk.png" alt="vk" width="24" height="24">
                </a>
            </td>
            <td>
                <a href="https://t.me/gedocorp" target="_blank" style="font-size: 14px; text-decoration: none; color: #3498db;">
                    <img src="https://gedocorp.ru/img/icon_telegram.png" alt="tg" width="24" height="24">
                </a>
            </td>
        </tr>
